(function () {
function pic_color(color, elmnt) {
    if (!(this instanceof pic_color)) { return new pic_color(color, elmnt); }
...
window.pic_color = pic_color;

(function () {
    var z, i, att;
    z = document.getElementsByTagName("*");
    for (i = 0; i < z.length; i++) {
        att = z[i].getAttribute("data-pic_color");
        if (att) {
            z[i].style.backgroundColor = pic_color(att).toRgbString();            
        }
    }
})();
